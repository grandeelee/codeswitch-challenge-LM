...
def load_mono_data(params, data):
    ...
    """
    data['cs'] = {}
    for splt in ['valid', 'test', 'adapt', 'test_cs', 'test_zh', 'test_en', 'test_cs_en_norm', 'test_cs_zh_norm']:
        data['cs'][splt] = {}
...
def load_data(params):
    ...
    for data_set in ['valid', 'test', 'adapt', 'test_cs', 'test_en', 'test_zh', 'test_cs_en_norm', 'test_cs_zh_norm']:
        logger.info(
